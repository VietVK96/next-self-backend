export enum ErrorCode {
  ...
  USER_EXPIRED_LICENSE = 'USER_EXPIRED_LICENSE',
  ...
  INVALID_ARGS_SET_AMOUNT_DUE = 'INVALID_ARGS_SET_AMOUNT_DUE',
  AMOUNT_NO_CHANGE_DETECT = 'AMOUNT_NO_CHANGE_DETECT',
  FULLY_STORAGE_SPACE = 'FULLY_STORAGE_SPACE',
  ERROR_GET_USER = 'ERROR_GET_USER',
  CANNOT_EDIT_USER = 'CANNOT_EDIT_USER',
  DUPLICATE = 'DUPLICATE',
  MAXIMUM = 'MAXIMUM',
  NOT_FOUND_DOMTOM = 'NOT_FOUND_DOMTOM',
  TOTALERR = 'TOTALERR',
  ...
  CALENDAR_ID_IS_REQUIRED = 'CALENDAR_ID_IS_REQUIRED',
  CANNOT_GET_CALENDAR_INFORMATION = 'CANNOT_GET_CALENDAR_INFORMATION',
  CAN_NOT_COPY_LIBRARY_ACT = 'CAN_NOT_COPY_LIBRARY_ACT',
  INVALID_PARAMETER = 'INVALID_PARAMETER',
  NOT_FOUND_COOKIE = 'NOT_FOUND_COOKIE',
  NOT_FOUND_EMAIL_SETTING = 'NOT_FOUND_EMAIL_SETTING',
  CANNOT_SEND_MAIL = 'CANNOT_SEND_MAIL',
  NOT_FOUND_RESOURCES = 'NOT_FOUND_RESOURCES',
  NOT_FOUND_USER = 'NOT_FOUND_USER',
  ERROR_GET_PERCENT_IMPORT = 'ERROR_GET_PERCENT_IMPORT',
  TAG_TITLE_ALREADY_USED = 'TAG_TITLE_ALREADY_USED',
  NOT_HAVE_ORGANIZATION = 'NOT_HAVE_ORGANIZATION',
  BORDEREAU_PAYMENT_IS_EMPTY = 'BORDEREAU_PAYMENT_IS_EMPTY',
  NOT_FOUND_SLIPCHECK = 'NOT_FOUND_SLIPCHECK',
  CANNOT_DELETE_TRACEABILITY = 'CANNOT_DELETE_TRACEABILITY',
